...
| 3 | Costiera Amalfitana | Positano, Praiano, Amalfi, Ravello, Maiori, Minori, Cetara, Vietri sul Mare | 🟠 CSV provvisorio (PageSpeed da fare) | _ricerca_intermedia/CSV_Costiera_Amalfitana.csv |
| 4 | Salerno e agro | Salerno città, Cava de' Tirreni | 🟠 CSV provvisorio (PageSpeed da fare) | _ricerca_intermedia/CSV_Salerno.csv |
| 5 | Cilento e Paestum | Agropoli, Castellabate, Palinuro, Marina di Camerota, Paestum/Capaccio, Vallo della Lucania, Sapri | 🟠 CSV provvisorio (PageSpeed da fare) | _ricerca_intermedia/CSV_Cilento.csv |
