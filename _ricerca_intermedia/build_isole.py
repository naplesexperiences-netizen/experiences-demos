...
Input: isole_del_golfo_RAW.tsv (area,citta,nome,url,categoria,email,note)
       isole_del_golfo_pagespeed.tsv (area,citta,name,url,perf,seo,bp,stack,booking,images)
Output: CSV_<area>.csv nella cartella corrente.
"""
import csv, os, re, urllib.parse

HERE=os.path.dirname(os.path.abspath(__file__))
RAW=os.path.join(HERE,'isole_del_golfo_RAW.tsv')
PS=os.path.join(HERE,'isole_del_golfo_pagespeed.tsv')
TODAY='2026-06-10'
